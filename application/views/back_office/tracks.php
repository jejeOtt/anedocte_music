            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p style="text-align:left"><a class="btn btn-lg btn-warning" href="<?php echo site_url('/tracks/' . $track['slug']); ?>">Detail</a> <a class="btn btn-lg btn-info" href="<?php echo site_url('/back_office/validate_track/' . $track['idTrack']); ?>">Valider la track</a></p><br>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <iframe width="500" height="175" src="https://www.youtube.com/embed/<?php echo $track["url"]; ?>?autoplay=1&autohide=1&controls=1&showinfo=0&modestbranding=1&rel=0"></iframe>
                    </div>
                </div>
            </div>
        </div>
