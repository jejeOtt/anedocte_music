        ...
        <div class="container">
            ...
            <h5 class="h3 mb-3 fw-bold">Inscription</h5>
                ...
                <div class="form-group">
                        ...
                        <div class="form-group">
							<label for="password" class="cols-sm-2 control-label">Date de naissance</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="dateOfBirth" placeholder="Renseignez votre date de naissance"/>
								</div>
							</div>
						</div>
